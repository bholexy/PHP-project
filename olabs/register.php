	...
	<div class="row">
		<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" method="post" name="registration_form">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-6">
						<div class="form-group">
							<input type ="text" id="date_added" name="date_added" value="<?php echo date("h:i:s A")?>"/>
				...
				<div class="form-group">
					<input type="text" name="matric_no" id="matric_no" class="form-control input-lg" placeholder="Matric Number" tabindex="5" required>				
				</div>
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-6">
						<div class="form-group">
