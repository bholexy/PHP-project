         ...
         if ($start_time > $end_time) {?>
            <script>
             ...
             <?php
                    ...
                    $sql = "INSERT INTO schedule (full_name, s_date, start_time, end_time)
                        VALUES ('$full_name', '$s_date', '$start_time', '$end_time')";
...
<div class="jumbotron">
    <div class="alert alert-success" role="alert">
        <?php 
            ...
            if(logged_in()) {
            echo "Welcome " . get_name($_SESSION['full_name']);
        }else{
            redirect("LOGIN.php");
        }
    ...
    <h1 class="text-center"> Lecturer Appointment Booking System - Home </h1>
</div>
